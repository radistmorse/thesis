...
\begin{figure}
\center{
\includegraphics[width=1.0\textwidth]{figures/ATLAS_overview.png}
\caption[Overview of the ATLAS detector, with all the major sub-systems and the human-sized scale figures.]{Overview of the ATLAS detector, with all the major sub-systems and the human-sized scale figures.~\cite{lib:ATLASdet}.}
\label{fig:ATLAS_overview}}
\end{figure}

The overview of the ATLAS detector is shown in the Figure~\ref{fig:ATLAS_overview}. The main detector sub-systems can be seen there: the innermost is the tracker, then goes the EM calorimeters, the hadronic calorimeters, and finally the muon spectrometers. There is also a magnet system, which is not a detector by itself, but is essential to the functioning of the whole system. All of the sub-detectors are briefly described below.
...
$Z$-bosons are short-lived, and do not interact even with the innermost parts of the detector. What we detect and record are the decay products of the said particles.
...
\caption[Overview of the ATLAS tracker. The SCT, TRT and pixel detectors are shown there.]{Overview of the ATLAS tracker. The SCT, TRT and pixel detectors are shown there.~\cite{lib:ATLASdet}.}
...
\caption[Overview of the ATLAS EM and hadronic calorimeters.]{Overview of the ATLAS EM and hadronic calorimeters.~\cite{lib:ATLASdet}.}
...
\caption[Overview of the ATLAS muon chambers.]{Overview of the ATLAS muon chambers.~\cite{lib:ATLASdet}.}
...
\caption[Overview of the ATLAS magnet system.]{Overview of the ATLAS magnet system.~\cite{lib:ATLASdet}.}
