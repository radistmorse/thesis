...
\subfigure[Mass window, $\et^{miss}$, $\et$] {\includegraphics[width=0.32\textwidth]{figures/bkg_wenu_3.pdf}}

\caption{The data-fitting of the \Wenu\ background with various selections. (a) Mass window selection, (b) Mass window and $\et^{miss} > 25$~GeV, (c) Mass window, $\et^{miss} > 25$~GeV and $\et > 50$~GeV.}
\label{fig:bkg_wenu}}
\end{figure}
...
\caption{The control plot for the QCD background estimation. Dotted lines show the boundaries of the tail region for the $\et^\mathrm{cone30}/\et$ discriminatory variable.}
