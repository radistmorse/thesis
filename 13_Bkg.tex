...
\center{
  ...
  \caption{The comparison between data and MC for central electron $p_T$ distribution for peak mass and high mass regions.}
...
\center{
  ...
  \caption{The comparison between data and MC for forward electron $p_T$ distribution for peak mass and high mass regions.}
...
\center{
  ...
  \caption{The comparison between data and MC for $Z$ boson $p_T$ distribution for peak mass and high mass regions.}
