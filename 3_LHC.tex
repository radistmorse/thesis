...
\caption{The LHC accelerator complex. For each accelerator the year of completion is shown. For circular accelerators the length of the ring is also shown.~\cite{lib:cernposters}}
\label{fig:LHC}}
\end{figure}
